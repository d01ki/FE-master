    ...
    def create_sample_questions(self) -> List[Dict]:
        ...
        sample_questions = [
            ...
            },
            {
                ...
                "choices": {
                    "ア": "FIFO（First In First Out）の原則で動作する",
                    "イ": "LIFO（Last In First Out）の原則で動作する", 
                    "ウ": "ランダムアクセスが可能である",
                    "エ": "要素の追加はできるが削除はできない"
                },
                "correct_answer": "イ",
                "explanation": "スタック（Stack）は、LIFO（Last In First Out、後入れ先出し）の原則で動作するデータ構造です。最後に追加された要素が最初に取り出されます。",
                "genre": "アルゴリズム・データ構造"
            },
            {
                "question_id": "Q007",
