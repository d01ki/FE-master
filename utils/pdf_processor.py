...
class PDFProcessor:
    ...
    def create_extended_sample_questions(self) -> List[Dict]:
        ...
        extended_questions = [
            ...
            {
                "question_id": "Q011",
                "question_text": "システム開発のウォーターフォールモデルの特徴として正しいものはどれか。",
                "choices": {
                    "ア": "各工程を並行して実行する",
                    "イ": "要件の変更に柔軟に対応できる",
                    "ウ": "前の工程に戻ることを前提としている",
                    "エ": "各工程を順番に実行し、前の工程には戻らない"
                },
                "correct_answer": "エ",
                "explanation": "ウォーターフォールモデルは、要件定義、設計、実装、テスト、運用の各工程を順番に実行し、基本的に前の工程には戻らない開発手法です。",
                "genre": "システム開発"
            },
            {
                "question_id": "Q012",
                "question_text": "ファイルシステムにおいて、ファイルの実際の格納場所を管理するデータ構造は何か。",
                "choices": {
                    "ア": "ディレクトリ",
                    "イ": "inode",
                    "ウ": "パーティション",
                ...
                "correct_answer": "イ",
                "explanation": "inode（アイノード）は、Unixファイルシステムにおいて、ファイルのメタデータ（サイズ、権限、タイムスタンプ、データブロックの場所など）を格納するデータ構造です。",
                "genre": "ソフトウェア"
            },
            {
                "question_id": "Q013",
                "question_text": "IPアドレス192.168.1.0/24のネットワークで利用可能なホストアドレスの数はどれか。",
                "choices": {
                    "ア": "254",
                    "イ": "255",
                    "ウ": "256",
                ...
                "correct_answer": "ア",
                "explanation": "/24はサブネットマスクが255.255.255.0を意味し、ホスト部は8ビットです。2^8=256個のアドレスのうち、ネットワークアドレス(.0)とブロードキャストアドレス(.255)を除いた254個がホストアドレスとして利用可能です。",
                "genre": "ネットワーク"
            },
            {
                "question_id": "Q014",
                "question_text": "ソフトウェアテストにおけるブラックボックステストの特徴はどれか。",
                "choices": {
                    "ア": "プログラムの内部構造を詳細に調べる",
                    "イ": "入力と期待される出力の関係のみに注目する",
                    "ウ": "コードカバレッジを測定する",
                    "エ": "変数の値の変化を追跡する"
                },
                "correct_answer": "イ",
                "explanation": "ブラックボックステストは、プログラムの内部構造を考慮せず、入力値に対する出力値が仕様通りかどうかを検証するテスト手法です。",
                "genre": "システム開発"
            },
            {
                "question_id": "Q015",
                "question_text": "プロジェクト管理におけるクリティカルパスとは何か。",
                "choices": {
                    "ア": "最も重要なタスクの集合",
                    "イ": "最もコストがかかる作業の流れ",
                    "ウ": "プロジェクト完了までの最長経路",
                ...
                "correct_answer": "ウ",
                "explanation": "クリティカルパスは、プロジェクトの開始から完了までの最長経路を指し、この経路上のタスクに遅延が生じると、プロジェクト全体の完了が遅延します。",
                "genre": "マネジメント"
            }
        ]
